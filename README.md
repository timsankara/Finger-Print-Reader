...
## Running the code
The image_convert.py file takes an image name as an argument then converts it into a .tiff image and saves it to the /database folder
The app.py file takes two image names and compares them to determine if they are a match